  ...
  return (
    <section className="relative overflow-hidden">
      ...
      <div className="relative mx-auto flex w-full max-w-7xl flex-col items-center gap-8 px-4 py-20 text-center sm:px-6 lg:flex-row lg:justify-between lg:text-left">
        ...
        <a
          href="#contact"
          className="group inline-flex shrink-0 items-center gap-2 rounded-full bg-sand-400 px-8 py-4 text-sm font-bold text-navy-950 shadow-xl shadow-black/25 transition-all hover:-translate-y-0.5 hover:bg-sand-300"
        >
